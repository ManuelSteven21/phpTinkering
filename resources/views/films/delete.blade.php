...
<main class="flex-grow px-4 sm:px-6 lg:px-8"> <!-- Afegit padding lateral -->
    <div class="max-w-md mx-auto bg-white bg-opacity-80 shadow-lg rounded-lg p-8 mt-6 mb-6">
        <h1 class="text-3xl font-bold mb-4 text-center text-black">Delete Film</h1>
        <p class="text-center text-gray-700">Vols eliminar la peli "<strong><?= htmlspecialchars($film->name) ?></strong>"?</p>
        <form action="/destroy" method="POST" class="mt-4 text-center">
        ...
        <a href="/" class="text-gray-500 hover:underline mt-4 block text-center">Cancel·lar</a>
    </div>
</main>
