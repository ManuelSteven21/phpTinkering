...
<main class="flex-grow px-4 sm:px-6 lg:px-8"> <!-- Afegit padding lateral -->
    <div class="max-w-4xl mx-auto bg-white bg-opacity-80 shadow-lg rounded-lg p-6 mt-8 mb-6">
        <h1 class="text-3xl font-bold mb-4 text-center text-gray-900">Films</h1>

        <!-- Contenidor per al botó i la taula amb marges -->
        <div class="space-y-4">
            <div class="add-film flex justify-end mb-4">
                <a href="/create" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 transition duration-300">Add New Film</a>
            </div>
                ...
                <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100 transition duration-300">
                        ...
                        <td class="py-3 px-6 text-center">
                            <a href="/edit/<?= $film['id'] ?>" class="text-blue-500 hover:text-blue-700 mr-4 transition duration-300">Edit</a>
                            <a href="/delete/<?= $film['id'] ?>" class="text-red-500 hover:text-red-700 transition duration-300">Delete</a>
                        </td>
                        <td class="py-3 px-6 text-center"> <!-- Columna de Detalls -->
                            <a href="/films/show/<?= $film['id'] ?>" class="text-green-500 hover:text-green-700 transition duration-300">Show More Info</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    <?php endif; ?>
